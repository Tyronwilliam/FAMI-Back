...
export interface ApiEvenementEvenement extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::evenement.evenement'> &
      Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
...
export interface ApiRedirectionRedirection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    content: Schema.Attribute.Component<'composant.lien', false>
    createdAt: Schema.Attribute.DateTime
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
    identifiant: Schema.Attribute.String
    locale: Schema.Attribute.String & Schema.Attribute.Private
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::redirection.redirection'> &
      Schema.Attribute.Private
    publishedAt: Schema.Attribute.DateTime
    updatedAt: Schema.Attribute.DateTime
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private
